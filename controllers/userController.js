...
const tokenBlacklist = require('../utils/tokenBlacklist');
const Category = require('../models/Category');
// const upload = require('../uploads/profilePictures');
// const path = require('path');




////////////--------Upload file creation and upload file functionality---///////////
...
//     if (req.file) {
//       user.profilePic = req.file.buffer; // Save the image buffer to the profilePic field
//     }
